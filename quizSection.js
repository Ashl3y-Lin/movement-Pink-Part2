...
const questions = [
    {
        ...
        answers: [
            {text: "[left_speed: -50%] [right_speed: 50%]", correct: false}, 
            {text: "[left_speed: 50%] [right_speed: 50%]", correct: true}, 
            {text: "[left_speed: -50%] [right_speed: -50%]", correct: false}, 
            {text: "[left_speed: 0%] [right_speed: 50%]", correct: false}, 
        ]
    },
    {
        question: "What is a spin turn?" ,
        answers: [
            {text: "When one wheel move and the other do not.", correct: false}, 
            {text: "When both wheels turn, but in different direction.", correct: true}, 

        ]
    },
    {
        question: "how do you make the robot make a spin turn?" ,
        answers: [
            {text: "[left_speed: -50%] [right_speed: 50%]", correct: true}, 
            {text: "[left_speed: 50%] [right_speed: 50%]", correct: false}, 
            {text: "[left_speed: -50%] [right_speed: -50%]", correct: false}, 
    ...
    },
    {
        ...
        answers: [
            {text: "[left_speed: -50%] [right_speed: -50%]", correct: false}, 
            {text: "[left_speed: -70%] [right_speed: -70%]", correct: true}, 
        ]
    },
    {
        question: "how do you make the robot make a pivot turn?" ,
        answers: [
            {text: "[left_speed: -20%] [right_speed: 20%]", correct: false}, 
            {text: "[left_speed: -50%] [right_speed: -50%]", correct: false}, 
            {text: "[left_speed: 0%] [right_speed: 30%]", correct: true}, 
            {text: "[left_speed: 45%] [right_speed: 45%]", correct: false}, 
        ]
    },
];
